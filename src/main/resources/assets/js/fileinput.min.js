...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            var i, a, r, n, o, l, s, d, c, p, u, f, m, v, g, h, w, _, b, C, y, x, T, E, S, k, F, I, P, A, D, z, $, j, U,
                B, R, L, O = this;
            ...
            i.previewCache = {
                data: {}, init: function () {
                    ...
                    if (a) {
                        ...
                        i.previewCache.data.content = t.spliceArray(i.previewCache.data.content, e), i.previewCache.data.config = t.spliceArray(i.previewCache.data.config, e), i.previewCache.data.tags = t.spliceArray(i.previewCache.data.tags, e)
                    }
                }, out: function () {
            ...
            window.KvSortable && 0 !== r.find(n).length && (i = {
                ...
                onSort: function (i) {
                    ...
                    a.initialPreview = t.moveArray(a.initialPreview, r, n), a.initialPreviewConfig = t.moveArray(a.initialPreviewConfig, r, n), a.previewCache.init(), a.getFrames(".file-preview-initial").each(function () {
            ...
            var a = this, r = i.attr("data-fileindex");
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                var T, E, S, k, F, I, P, A, D, z, $, j, U = v + x, B = u + "-" + U, R = i[x], L = m.text, O = m.image,
                    M = m.html, Z = R.name ? r.slug(R.name) : "", N = (R.size || 0) / 1e3, H = "",
                ...
                if (h > 0) for (E = 0; h > E; E++) I = g[E], P = r.msgFileTypes[I] || I, q += 0 === E ? P : ", " + P;
                ...
                if (!t.isEmpty(g) && t.isArray(g)) {
                    ...
                    if (0 === W) return S = r.msgInvalidFileType.setTokens({name: Z, types: q}), void y(S, R, B, x)
                }
                return 0 !== W || t.isEmpty(w) || !t.isArray(w) || t.isEmpty(H) || (F = t.compare(Z, H), W += t.isEmpty(F) ? 0 : F.length, 0 !== W) ? r.showPreview ? !C && N > b ? (r.addToStack(R), s.addClass("file-thumb-loading"), r._previewDefault(R, B), r._initFileActions(), r._updateFileDetails(f), void a(x + 1)) : (o.length && void 0 !== FileReader ? (D = L(R.type, Z), z = M(R.type, Z), $ = O(R.type, Z), d.html(c.replace("{index}", x + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                    ...
                    if (n = {name: Z, type: R.type}, e.each(m, function (e, t) {
                        ...
                        if (a = p.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(l.result), c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, R.type)), n = {
                                name: Z,
                                type: c
                            }, D = L(c, ""), z = M(c, ""), $ = O(c, ""), j = D || z, j || $) return void u(j)
                    }
